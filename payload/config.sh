...
#
# NOTE: keep comments OUTSIDE this assignment. Inside a quoted,
# backslash-continued string a '#' is literal text, not a comment, so the words
# land in $PKGS_NET and apt-get install reports "Unable to locate package #",
# "... package OCTEON", one per word. That is what broke the build between
# 2026-08-27 and 2026-09-02.
